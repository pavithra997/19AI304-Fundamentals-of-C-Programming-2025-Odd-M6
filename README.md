...
```
# Output:
<img width="1060" height="673" alt="image" src="https://github.com/user-attachments/assets/a9c609a3-1899-4678-b4ab-838a10e6ed5b" />
...
int main() { int num1, num2, choice, result; int (*operation)(int, int);
...
```
# Output:
<img width="1025" height="652" alt="image" src="https://github.com/user-attachments/assets/a2fdf362-25cf-4fdd-8942-dd5ef8c6cd3c" />
...
struct employee { int eno; char ename[50]; float salary; };
...
```
# Output:
<img width="807" height="821" alt="image" src="https://github.com/user-attachments/assets/78f6340c-ad90-4c2b-8562-e0911ff7daa8" />
...
struct date { int c_date, c_month, c_year; int b_date, b_month, b_year; int cal_date, cal_month, cal_year; };

void findAge(struct date *d) { int month[] = {31,28,31,30,31,30,31,31,30,31,30,31};
...
```
# Output:
<img width="877" height="436" alt="image" src="https://github.com/user-attachments/assets/40461a09-952c-426f-a4da-548403024da0" />
...
int main() { union abc var; union abc *ptr;
...
```
# Output:
<img width="989" height="488" alt="image" src="https://github.com/user-attachments/assets/d68e543a-fedf-47be-a164-66998180433a" />
